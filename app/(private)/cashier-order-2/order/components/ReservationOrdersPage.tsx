...
//             const { data: ordersResponse, isFetching: ordersFetching } =
//               useGetOrdersByReservationIdQuery(reservation.id);
...
//                       <p className="text-gray-800">
//                         {reservation.detail.numberOfPeople}
//                       </p>
//                     </div>
//                     <div>
//                       <p className="text-gray-600 font-medium">Bàn</p>
//                       <span
//                         className={getTableBadgeStyle(
//                           reservation.detail.status,
//                         )}
//                       >
...
//                     <p className="text-gray-800">
//                       {formatDateTime(reservation.timeIn)}
//                     </p>
//                   </div>
//                   <Button
//                     variant="default"
